...
return botui.action.button({
  ...
  if(perc>=75)
  msg='There is a possibility that you may be Corona positive. You urgently need to talk to doctor!';
  else if(perc>45 && perc<75)
  msg='There is a slight possibility that you may be Corona positive. You should have a checkup!';
  else if(perc<=45)
  msg='Chill! You are alright. Enjoy!';
